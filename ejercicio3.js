...
// Filtrar las canciones de rock que duren más de 5 minutos
for (const song of songs) {
  if (song.genre === 'Rock' && song.duration > 5) {
    rockPlaylist.push(song); // Añadir a la playlist si cumple las condiciones
  }
}

// Imprimir la nueva playlist
console.log('Rock Playlist:', rockPlaylist);
